...
% iteration phase
  ...
  disp(sprintf('SREDKM: Loop=%g, Explained variance=%g, iter=%g, fdif=%g',loop,f*100, it,fdif))   
       if loop==1
            Urkm=U;
            Arkm=A;
            Yrkm=Xs*Arkm;
...
Urkm=Urkm(:,ic);
disp(sprintf('REDKM (Final): Percentage Explained variance=%g, looprkm=%g, iter=%g, fdif=%g',frkm*100, looprkm, inrkm,fdifo))
